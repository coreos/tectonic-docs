...
* **CoreOS Tectonic account**: Register for a [CoreOS Tectonic account][account-login], which is free for up to 10 nodes. You must provide the account's License and Pull Secret during installation.
