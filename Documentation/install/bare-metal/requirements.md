...
* [CoreOS Tectonic account][account-login]. Register for a CoreOS Tectonic account, which is free for up to 10 nodes. The account's License and Pull Secret are required during installation of Tectonic.
