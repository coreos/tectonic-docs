...
```sh
wget https://releases.tectonic.com/releases/tectonic_1.8.4-tectonic.3.zip
unzip tectonic_1.8.4-tectonic.3.zip
cd tectonic_1.8.4-tectonic.3/tectonic-installer
```
...
[latest-tectonic-release]: https://releases.tectonic.com/releases/tectonic_1.8.4-tectonic.3.zip
