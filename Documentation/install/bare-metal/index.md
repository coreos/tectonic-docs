...
```sh
wget https://releases.tectonic.com/releases/tectonic_1.8.4-tectonic.1.zip
unzip tectonic_1.8.4-tectonic.1.zip
cd tectonic_1.8.4-tectonic.1/tectonic-installer
```
...
[latest-tectonic-release]: https://releases.tectonic.com/releases/tectonic_1.8.4-tectonic.1.zip
