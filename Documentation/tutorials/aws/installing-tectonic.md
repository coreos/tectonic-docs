...
```
$ curl -O https://releases.tectonic.com/releases/tectonic_1.7.14-tectonic.2.zip
$ curl -O https://releases.tectonic.com/releases/tectonic_1.7.14-tectonic.2.zip.sig
```
...
$ gpg2 --verify tectonic_1.7.14-tectonic.2.zip.sig tectonic_1.7.14-tectonic.2.zip
...
```bash
$ unzip tectonic_1.7.14-tectonic.2.zip
$ cd tectonic_1.7.14-tectonic.2/tectonic-installer # to change to the previously untarred directory
